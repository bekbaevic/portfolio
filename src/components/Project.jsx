...
const Project = () => {
  return (
    <div className="w-full py-6 px-10 md:px-20 flex flex-col items-center">
      ...
      <div className="w-full grid grid-cols-1 sm:max-w-[600px] lg:max-w-[100%] lg:grid-cols-3 gap-4">
        ...
        <NavLink
          to="projects"
          className="relative bg-[#05409a] h-full w-full flex justify-center items-center rounded-sm text-[22px] font-[700] min-h-[60px] text-[#fff] py-2"
        >
